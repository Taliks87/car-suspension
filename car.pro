...
unrealRootPath=/home/talik/work/UE4/UnrealEngine
carRootPath=/opt/work/ue4/car

gameProjectFile=/opt/work/ue4/car/car.uproject
...
include(carSource.pri)
include(carHeader.pri)
include(carConfig.pri)
include(carIncludes.pri)
include(carDefines.pri)
...
car-Linux-Debug.commands = $$build car Linux Debug  -project="\"$$gameProjectFile\"" $$args
car-Linux-DebugGame.commands = $$build car Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
car-Linux-Shipping.commands = $$build car Linux Shipping  -project="\"$$gameProjectFile\"" $$args
car-Linux-Test.commands = $$build car Linux Test  -project="\"$$gameProjectFile\"" $$args
car.commands = $$build car Linux Development  -project="\"$$gameProjectFile\"" $$args

carEditor-Linux-Debug.commands = $$build carEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
carEditor-Linux-DebugGame.commands = $$build carEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
carEditor-Linux-Shipping.commands = $$build carEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
carEditor-Linux-Test.commands = $$build carEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
carEditor.commands = $$build carEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	car-Linux-Test \
	car \
	carEditor-Linux-Debug \
	carEditor-Linux-DebugGame \
	carEditor-Linux-Shipping \
	carEditor-Linux-Test \
	carEditor \
