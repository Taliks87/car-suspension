...
car-Linux-Debug:
	 $(PROJECTBUILD) car Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

car-Linux-DebugGame:
	 $(PROJECTBUILD) car Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

car-Linux-Shipping:
	 $(PROJECTBUILD) car Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

car-Linux-Test:
	 $(PROJECTBUILD) car Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

car:
	 $(PROJECTBUILD) car Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

carEditor-Linux-Debug:
	 $(PROJECTBUILD) carEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

carEditor-Linux-DebugGame:
	 $(PROJECTBUILD) carEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

carEditor-Linux-Shipping:
	 $(PROJECTBUILD) carEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

carEditor-Linux-Test:
	 $(PROJECTBUILD) carEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

carEditor:
	 $(PROJECTBUILD) carEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
